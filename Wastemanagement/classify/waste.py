...
# Constants
MODEL_PATH = 'classify/models/waste_model.h5'
...
page = st.sidebar.selectbox("Choose a page:", ["Capture Image", "Upload an Image",])
...
if page == "Upload an Image":
    st.markdown('**To get a prediction please upload your own clear image of some waste.**')
